...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-stone-800 text-white hover:bg-stone-900 border border-transparent",
        destructive: "bg-red-500 text-white hover:bg-red-600",
        cool: "dark:inset-shadow-2xs dark:inset-shadow-white/10 bg-linear-to-t border border-b-2 border-zinc-950/40 from-rose-400 to-rose-300 shadow-md shadow-rose-150 ring-1 ring-inset ring-white/25 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 text-white",
        outline: "border border-stone-200 bg-white hover:bg-stone-50 hover:text-stone-800",
        secondary: "bg-stone-100 text-stone-700 hover:bg-stone-200",
        ghost: "hover:bg-stone-100 hover:text-stone-800",
        link: "text-[#F2A7B5] underline-offset-4 hover:underline",
      },
      size: {
...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-transparent hover:scale-105 duration-300 transition text-stone-800",
        destructive:
...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-rose-500 via-rose-400 to-amber-100",
    button: "bg-gradient-to-b from-[#F2A7B5] to-[#f4b6c2]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(242_167_181_/_100%)]",
  },
  success: {
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      "relative z-10 m-[1px] rounded-md inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden decoration-none text-sm leading-none font-semibold will-change-transform outline-none border-none",
      colors.button,
      colors.textColor,
      colors.textShadow,
    ),
